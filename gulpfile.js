...
const watcher = () => {
  ...
  gulp.watch(`${app.paths.resourcesFolder}/**`, fonts);
...
const dev = gulp.series(clean, htmlInclude, scripts, styles, resources, fonts, images, webpImages, avifImages, svgSprites, watcher);
const backend = gulp.series(clean, htmlInclude, scriptsBackend, stylesBackend, resources, fonts, images, webpImages, svgSprites);
const build = gulp.series(clean, htmlInclude, scripts, styles, resources, fonts, images, webpImages, avifImages, svgSprites);
